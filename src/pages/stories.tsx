          ...
          {loading ? (
            ...
            <Fragment>
              ...
              <Container style={{ textAlign: 'center' }}>
                {page === 0 ? null :
                  <Button variant="outlined" onClick={() => loadLess()} style={{ backgroundColor: '#9FC3D1', margin: 20 }}>
                    Prev
              </Button>}

                {data.items.length < limit ? null : <Button variant="outlined" onClick={() => loadMore()} style={{ backgroundColor: '#9FC3D1', margin: 20 }}>
                  Next
              </Button>}
              </Container>
            </Fragment>
