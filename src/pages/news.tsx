    ...
    <Layout>
      ...
      <Container maxWidth='md'>
        <Card className={classes.root}>
          <CardActionArea href={"http://news.worldoftg.com"}>
            <CardContent>
              TG News
        </CardContent>
          </CardActionArea>
            ...
            {loading ? (
              ...
              <Fragment>
                ...
                <Container style={{ textAlign: 'center' }}>
                  {page === 0 ? null :
                    <Button variant="outlined" onClick={() => loadLess()} style={{ backgroundColor: '#8B8BBF', margin: 20 }}>
                      Back
              </Button>}
                  {data.items.length < limit ? null : <Button variant="outlined" onClick={() => loadMore()} style={{ backgroundColor: '#8B8BBF', margin: 20 }}>
                    Next
              </Button>}
                </Container>
              </Fragment>
