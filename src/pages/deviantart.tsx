            ...
            {loading ? (
              ...
              <Fragment>
                ...
                <Container style={{ textAlign: 'center' }}>
                  {page === 0 ? null :
                    <Button variant="outlined" onClick={() => loadLess()} style={{ backgroundColor: '#A5CF87', margin: 20 }}>
                      Back
              </Button>}
                  {data.items.length < limit ? null : <Button variant="outlined" onClick={() => loadMore()} style={{ backgroundColor: '#A5CF87', margin: 20 }}>
                    Next
              </Button>}
                </Container>
              </Fragment>
