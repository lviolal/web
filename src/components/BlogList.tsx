...
export default function BlogList({path}) {
        ...
        <Fragment>
          {loading ? (
            ...
            <Fragment>
              ...
              {data.items.length < limit ? null : <Button variant="outlined" onClick={() => loadMore()} style={{ backgroundColor: 'white', margin: 20 }}>
                Next
              </Button>}
            </Fragment>
          ) : null}
